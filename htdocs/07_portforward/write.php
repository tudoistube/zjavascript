...
<head>
     ...
     <link rel="stylesheet" type="text/css"
           href="http://localhost/07_portforward/style.css">
</head>
<body id="ztarget">
    ...
    <div class="container">
      <header class="jumbotron text-center">
  		    <h2>
              <a href="http://localhost/07_portforward/index.php">
      ...
      <div class="row">
          ...
          <ol class="nav nav-pills nav-stacked">
            <?php
              ...
              while ($zrow = mysqli_fetch_assoc($zresult)) {
                ...
                echo '<li><a href="http://localhost/07_portforward/index.php?id='.$zrow['id'].' ">'
        ...
        <div class="col-md-9">
          <div id="zcontrol">
            ...
            <a href="http://localhost/07_portforward/write.php" class="btn btn-success  btn-lg">글쓰기</a>
          </div>
          <hr>
