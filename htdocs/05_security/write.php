...
<head>
     ...
     <link rel="stylesheet" type="text/css"
           href="http://localhost/05_security/style.css">
</head>
<body id="ztarget">
    <header>
		    <h2><a href="http://localhost/05_security/index.php"><img src="https://yt3.ggpht.com/-thKQ_YaH8MM/AAAAAAAAAAI/AAAAAAAAAAA/Eaihw8GhhlE/s88-c-k-no-mo-rj-c0xffffff/photo.jpg" alt="생활코딩실습"></a></h2>
      ...
      <ol>
        <?php
          ...
          while ($zrow = mysqli_fetch_assoc($zresult)) {
            ...
            echo '<li><a href="http://localhost/05_security/index.php?id=0'.$zrow['id'].' ">' . $zrow['title'] . '</a></li>' . "\n";
            //echo "<br/>";
          }
         ?>
      </ol>
    ...
    <div id="zcontrol">
      ...
      <a href="http://localhost/05_security/write.php">글쓰기</a>
    </div>
